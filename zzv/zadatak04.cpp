...
public:
	Ispit(const char* predmet, const char* datumOdrzavanja, const char*
		  vrijemeOdrzavanja, int trajanje) {
	...
	void Info() {
		...
		cout << "Termin ispita: " << _datumOdrzavanja << " u " <<
			_vrijemeOdrzavanja << endl;
